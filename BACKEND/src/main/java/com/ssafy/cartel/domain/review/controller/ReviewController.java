package com.ssafy.cartel.domain.review.controller;

import com.ssafy.cartel.domain.review.service.ReviewService;
...
public class ReviewController {
    ...
    public ResponseEntity<?> findReview(@PathVariable Integer review_id) {
        Optional<Review> review = reviewService.findById(review_id);
