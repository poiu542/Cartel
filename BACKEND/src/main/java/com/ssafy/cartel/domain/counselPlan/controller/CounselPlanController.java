package com.ssafy.cartel.domain.counselPlan.controller;

import com.ssafy.cartel.domain.day.dto.DayDto;
import com.ssafy.cartel.domain.day.service.DayService;
...
public class CounselPlanController {
    ...
    public ResponseEntity<?> findDay(@PathVariable Integer counsel_plan_id) {
        DayDto dayDto = dayService.findById(counsel_plan_id);
