package com.ssafy.cartel.domain.counsel.entity;
...
public class Counsel {
    ...
    @Builder
    public Counsel(Integer counselId, LocalDate startDate,LocalDate endDate, Integer counselCount, String title, Integer state, Integer clientCount, Integer price,Counselor counselorId, String introduction, Integer weekCount) {
        this.id = counselId;
