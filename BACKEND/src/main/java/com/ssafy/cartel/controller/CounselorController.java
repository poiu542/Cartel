...
public class CounselorController {
    ...
    public ResponseEntity<String> signupCounselor(@RequestPart("request") CounselorSignupRequest request, @RequestPart("file1") MultipartFile multipartFile1, @RequestPart("file2") MultipartFile multipartFile2, @RequestPart("file3") MultipartFile multipartFile3) throws IOException, IOException {
        System.out.println("!!!!!!!!!!!!!!!!!!!!!!!!!");
